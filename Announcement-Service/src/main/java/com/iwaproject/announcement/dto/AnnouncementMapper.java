...
public class AnnouncementMapper {
     ...
     */
    public Announcement toEntity(AnnouncementRequestDto dto, CareType careType) {
        if (dto == null) {
            return null;
        }
        ...
        announcement.setSpecificInstructions(dto.getSpecificInstructions());
        ...
        announcement.setIdentityVerificationRequired(dto.getIdentityVerificationRequired());
    ...
    public AnnouncementResponseDto toResponseDto(Announcement announcement) {
        ...
        dto.setSpecificInstructions(announcement.getSpecificInstructions());
        ...
        dto.setIdentityVerificationRequired(announcement.getIdentityVerificationRequired());
    ...
    /**
     * Convert list of Announcement entities to list of AnnouncementResponseDto.
     *
     ...
     */
    private CareTypeDto toCareTypeDto(CareType careType) {
        if (careType == null) {
            return null;
        }
